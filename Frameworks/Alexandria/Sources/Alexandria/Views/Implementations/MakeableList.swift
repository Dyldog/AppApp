...
public typealias MakeableListRow = Codable & MakeableView
...
public final class MakeableList: MakeableView {
    ...
    public func value(with variables: Variables, and scope: Scope) throws -> VariableValue {
        try MakeableStack(axis: .vertical, valueViews(with: variables, and: scope))
    }
...
//    @State var views: [any MakeableView] = []
    ...
    public var body: some View {
        VStack {
            ForEach(contentViews.enumeratedArray(), id: \.offset) { _, view in
                MakeableWrapperView(
                    isRunning: isRunning,
